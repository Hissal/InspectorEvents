...
public sealed class InspectorPhysics3DEvents : MonoBehaviour {
    ...
    [SerializeField, ShowIf(nameof(UsesOnControllerColliderHit)), HideLabel, InlineProperty]
    InspectorEvent<ControllerColliderHit> onControllerColliderHit = new();

    [SerializeField, ShowIf(nameof(UsesOnJointBreak)), HideLabel, InlineProperty]
