...
public sealed class InspectorTickEvents : MonoBehaviour {
    ...
    [SerializeField, ShowIf(nameof(UsesUpdate)), HideLabel, InlineProperty]
    InspectorEvent onUpdate = new();

    [SerializeField, ShowIf(nameof(UsesFixedUpdate)), HideLabel, InlineProperty]
    InspectorEvent onFixedUpdate = new();

    [SerializeField, ShowIf(nameof(UsesLateUpdate)), HideLabel, InlineProperty]
