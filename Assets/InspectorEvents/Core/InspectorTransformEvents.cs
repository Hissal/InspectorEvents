...
public sealed class InspectorTransformEvents : MonoBehaviour {
    ...
    [SerializeField, ShowIf(nameof(UsesOnTransformChildrenChanged)), HideLabel, InlineProperty]
    InspectorEvent onTransformChildrenChanged = new();

    [SerializeField, ShowIf(nameof(UsesOnTransformParentChanged)), HideLabel, InlineProperty]
