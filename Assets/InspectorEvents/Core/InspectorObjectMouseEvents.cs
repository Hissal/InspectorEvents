...
public sealed class InspectorObjectMouseEvents : MonoBehaviour {
    ...
    [SerializeField, ShowIf(nameof(UsesOnMouseEnter)), HideLabel, InlineProperty]
    InspectorEvent onMouseEnter = new();

    [SerializeField, ShowIf(nameof(UsesOnMouseExit)), HideLabel, InlineProperty]
    InspectorEvent onMouseExit = new();

    [SerializeField, ShowIf(nameof(UsesOnMouseDown)), HideLabel, InlineProperty]
    InspectorEvent onMouseDown = new();

    [SerializeField, ShowIf(nameof(UsesOnMouseUp)), HideLabel, InlineProperty]
    InspectorEvent onMouseUp = new();

    [SerializeField, ShowIf(nameof(UsesOnMouseUpAsButton)), HideLabel, InlineProperty]
    InspectorEvent onMouseUpAsButton = new();

    [SerializeField, ShowIf(nameof(UsesOnMouseDrag)), HideLabel, InlineProperty]
    InspectorEvent onMouseDrag = new();

    [SerializeField, ShowIf(nameof(UsesOnMouseOver)), HideLabel, InlineProperty]
