    ...
    ICancelHandler
{
    ...
    [SerializeField, ShowIf(nameof(UsesOnPointerMove)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onPointerMove = new();

    [SerializeField, ShowIf(nameof(UsesOnPointerEnter)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onPointerEnter = new();

    [SerializeField, ShowIf(nameof(UsesOnPointerExit)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onPointerExit = new();

    [SerializeField, ShowIf(nameof(UsesOnPointerDown)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onPointerDown = new();

    [SerializeField, ShowIf(nameof(UsesOnPointerUp)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onPointerUp = new();

    [SerializeField, ShowIf(nameof(UsesOnPointerClick)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onPointerClick = new();

    [SerializeField, ShowIf(nameof(UsesOnInitializePotentialDrag)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onInitializePotentialDrag = new();

    [SerializeField, ShowIf(nameof(UsesOnBeginDrag)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onBeginDrag = new();

    [SerializeField, ShowIf(nameof(UsesOnDrag)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onDrag = new();

    [SerializeField, ShowIf(nameof(UsesOnEndDrag)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onEndDrag = new();

    [SerializeField, ShowIf(nameof(UsesOnDrop)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onDrop = new();

    [SerializeField, ShowIf(nameof(UsesOnScroll)), HideLabel, InlineProperty]
    InspectorEvent<PointerEventData> onScroll = new();

    [SerializeField, ShowIf(nameof(UsesOnUpdateSelected)), HideLabel, InlineProperty]
    InspectorEvent<BaseEventData> onUpdateSelected = new();

    [SerializeField, ShowIf(nameof(UsesOnSelect)), HideLabel, InlineProperty]
    InspectorEvent<BaseEventData> onSelect = new();

    [SerializeField, ShowIf(nameof(UsesOnDeselect)), HideLabel, InlineProperty]
    InspectorEvent<BaseEventData> onDeselect = new();

    [SerializeField, ShowIf(nameof(UsesOnMove)), HideLabel, InlineProperty]
    InspectorEvent<AxisEventData> onMove = new();

    [SerializeField, ShowIf(nameof(UsesOnSubmit)), HideLabel, InlineProperty]
    InspectorEvent<BaseEventData> onSubmit = new();

    [SerializeField, ShowIf(nameof(UsesOnCancel)), HideLabel, InlineProperty]
